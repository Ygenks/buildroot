...
${OUTPUT_DIR}/host/bin/openocd -f board/stm32f469i-disco.cfg \
  ...
  -c "flash write_image erase ${OUTPUT_DIR}/images/stm32f469-disco.dtb 0x08040000" \
  -c "flash write_image erase ${OUTPUT_DIR}/images/xipImage 0x90000000" \
  -c "flash verify_image ${OUTPUT_DIR}/images/u-boot.bin 0x08000000" \
  -c "flash verify_image ${OUTPUT_DIR}/images/stm32f469-disco.dtb 0x08040000" \
